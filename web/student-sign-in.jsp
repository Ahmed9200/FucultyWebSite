            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        <h1 class="mb-2 bread">تسجيل الدخول</h1>
                        <p class="breadcrumbs"><span class="mr-2"><a href="index.html">الرئيسيه <i class="ion-ios-arrow-back"></i></a></span> <span> الدخول <i class="ion-ios-arrow-back"></i></span></p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-md-6 p-4 p-md-5  bg-light">
                        <form action="SignIn" method="POST">
                            <div class="form-group">
                                <input type="number" class="form-control" name="username" placeholder="الرقم القومي">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a href="admin-sign-in.jsp">الدخول كادمن</a>
                            </div>
                        </form>
                    </div>
                </div>
