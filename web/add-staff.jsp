                        ...
                        <div class="row">
                            ...
                            <div class="col-6 p-4 p-md-5 bg-light">
                                <form action="AddStaff" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group">
                                        <input type="tel" class="form-control" name="phone1" placeholder="رقم الهاتف 1" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="tel" class="form-control" name="phone2" placeholder="رقم الهاتف 2" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="edu_mail" placeholder="الإيميل الجامعي" required>
                                    </div>
                                    <div class="form-group row" style="padding-left: 15px; padding-right: 15px;">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="edu_status" placeholder="التخصص" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group row" style="padding-left: 15px; padding-right: 15px;">
                                        <label class="col-3" style="padding-top: 10px;">الوظيفه</label>
                                        <select class="form-control col-9" name="permession">                                            
                                            <option value="1">دكتور</option>
                                            <option value="2">معيد</option>
                                        </select>
                                    </div>
                                    <div class="form-group row" style="padding-left: 15px; padding-right: 15px;">
