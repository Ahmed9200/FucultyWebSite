...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse" style="min-height: 95vh">
    <div class="sidebar-sticky pt-3">
        ...
        <ul class="nav flex-column" id="staff">
            <li class="nav-item">
                <a class="nav-link" id="staff-panel-link" href="admin-panel.jsp">
        ...
        <%
            try {
                ...
                if (Helper.currentUser.getPermession_level().equals("1")
                        || Helper.currentUser.getPermession_level().equals("3")) {
        %>


        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
            <span>الهيئه الإداريه</span>
        </h6>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" id="add-staff" href="add-staff.jsp">
                    <i class="fa fa-address-card-o" aria-hidden="true"></i> إضافة عضو هيئة تدريس
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="add-admin" href="add-admin.jsp">
                    <i class="fa fa-address-card-o" aria-hidden="true"></i> إضافة عضو إداري
                </a>
            </li>
        </ul>
        ...
        <%
            ...
            if (Helper.currentUser.getPermession_level().equals("1")
                    || Helper.currentUser.getPermession_level().equals("2")) {
        %>
